...
# ✅ Copy project files into the container early for better caching
COPY . .
...
# ✅ Ensure virtual environment is correctly created & upgraded
...
# ✅ Step 1: Create the `fxcbot` script in a system-wide path BEFORE switching users
